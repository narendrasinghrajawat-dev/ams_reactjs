...
import { ShieldCheck, Mail, Phone, Building, Lock, Check, AlertCircle } from 'lucide-react';
...
export const AdminProfileScreen = () => {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.75rem', maxWidth: '840px' }}>
      {/* Header */}
      <div>
        <h3 style={{ fontSize: '1.5rem', fontWeight: 800 }}>Admin Security & Profile</h3>
        <p style={{ color: 'var(--text-secondary)', fontSize: '0.9rem' }}>
          Root account credentials and organization administrative profile.
        </p>
      </div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '1.5rem', flexWrap: 'wrap' }}>
          ...
          <div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginTop: '0.25rem' }}>
              <span className="badge badge-wfh">Super Admin</span>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '1.25rem' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
            ...
            <div>
              ...
              <div style={{ fontWeight: 600 }}>{currentUser?.email || 'admin@ams.com'}</div>
            </div>
          </div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
            ...
            <div>
              <div style={{ fontSize: '0.75rem', color: 'var(--text-secondary)' }}>Console Access</div>
              <div style={{ fontWeight: 600 }}>Role ID: 2 (Admin)</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="glass-card">
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.6rem', marginBottom: '1.25rem' }}>
          ...
          <h4 style={{ fontSize: '1.15rem' }}>Update Administrator Password</h4>
        </div>
